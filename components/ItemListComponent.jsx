...
const ItemListComponent = ({ control, register, setValue, errors }) => {
      ...
      <ul>
        {fields.map((item, index) => {
          return (
            <li
              key={index}
              className="space-y-6 pb-[48px] md:flex md:space-y-0 md:space-x-4"
            >
              <div className="form-control md:w-[40%]">
                <label
                  htmlFor="itemName"
                  className={`${
                    errors.itemName ? "text-red" : ""
                  } bodyText mb-[10px]`}
                >
                  Item Name
                </label>
              ...
              <div className="flex space-x-4 w-full md:w-[60%]">
                <div className="form-control w-[20%]">
                  ...
                  />
                  {errors.qty && (
                    <p className="errorMsg">{errors.qty.message}</p>
                  )}
                </div>
